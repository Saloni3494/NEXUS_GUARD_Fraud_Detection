          ...
          <div className="border border-gray-800 rounded-2xl p-6 bg-[#0A0A0A]">
            ...
            <div className="flex flex-col gap-4">
              <input
                ...
                className="bg-gray-900 p-3 rounded-lg border border-gray-700 focus:border-brand-cyan outline-none transition"
              ...
              <button
                ...
                className="mt-4 bg-brand-cyan hover:bg-brand-cyan/80 transition text-black p-3 rounded-xl font-bold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                  ...
                  {!result ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-5 bg-gray-900 rounded-xl border border-gray-700 animate-in fade-in slide-in-from-bottom-3">
                        <h3 className="font-semibold mb-3 text-brand-cyan flex items-center gap-2">
                          <span>🧬</span>
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-800 text-xs text-gray-400 text-center">
                          Benchmarked against <span className="text-brand-cyan font-semibold">{result.features.populationSize}</span>
                        </div>
                      </div>
