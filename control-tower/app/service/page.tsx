        ...
        <div className="w-full max-w-[1600px] mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-16 lg:gap-48">
          ...
          <div className="flex flex-col justify-center items-start gap-4 order-2 lg:order-1">
            ...
            <div className="pt-3 text-2xl md:text-3xl font-helvitica-neue leading-tight">
              ...
              <h2 className="text-brand-cyan">Digital Payments</h2>
              ...
              <form ref={formRef} onSubmit={handleFormSubmit} className="flex flex-col gap-4">
                <div className="space-y-4">
                  <input 
                    ...
                    required
                    className="w-full bg-transparent border border-gray-800 p-3 rounded-xl text-sm focus:border-brand-cyan outline-none text-white" 
                  />
                  <input 
                  ...
                  <select 
                    ...
                    required
                    defaultValue=""
                    className="w-full bg-black border border-gray-800 p-3 rounded-xl text-sm focus:border-brand-cyan outline-none text-gray-400 cursor-pointer"
                  >
                  ...
                  <textarea 
                    ...
                    required
                    className="w-full bg-transparent border border-gray-800 p-3 rounded-xl text-sm h-24 focus:border-brand-cyan outline-none resize-none text-white"
                  />
                </div>
                ...
                <button 
                  type="submit" 
                  disabled={isPending}
                  className="bg-brand-cyan hover:bg-brand-cyan/80 text-black font-bold py-3 rounded-2xl text-sm transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
