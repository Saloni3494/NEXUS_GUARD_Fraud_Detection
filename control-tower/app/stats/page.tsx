...
export default function StatsPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 w-full max-w-[1600px] mx-auto px-6 md:px-10 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
          <StatCard 
            icon={<Zap className="text-brand-cyan w-5 h-5" />} 
            label="Throughput" 
          ...
          />
          <StatCard 
            icon={<Gauge className="text-brand-cyan w-5 h-5" />} 
          ...
          <div className="flex flex-col gap-8">
            <div>
              <h2 className="text-2xl font-bold mb-2 uppercase tracking-tight">
                Network <span className="text-brand-cyan">Performance KPIs</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
              ...
              <div className="border border-gray-900 p-6 rounded-3xl bg-[#050505]">
                ...
                <div className="space-y-4">
                  <ProgressBar label="Accounts Frozen" percentage={stats.accountsFrozenPct}   color="bg-brand-cyan" />
            ...
            <div className="border border-gray-900 rounded-3xl overflow-hidden bg-[#0A0A0A]">
              <div className="p-4 border-b border-gray-900 bg-gray-900/20 text-xs font-bold uppercase tracking-wider flex justify-between">
                ...
                <span className="text-brand-cyan animate-pulse">Processing 1M+ Clusters</span>
              </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="border border-gray-900 p-8 rounded-3xl bg-[#0A0A0A] flex flex-col gap-6 shadow-2xl relative overflow-hidden">
              ...
              <h3 className="text-lg font-bold flex items-center gap-2 relative z-10">
                <Activity className="text-brand-cyan w-5 h-5" /> Operational Summary
              </h3>
              ...
              <div className="mt-4 p-4 bg-brand-cyan/10 border border-brand-cyan/20 rounded-2xl relative z-10">
                <p className="text-[11px] text-brand-cyan leading-relaxed italic">
    ...
    download
    className="w-full py-3 bg-brand-cyan hover:bg-brand-cyan/80 active:scale-[0.99]
...
function LogItem({ time, msg, node, risk }: any) {
  const riskColor = 
    ...
    risk === "STABLE" ? "text-brand-cyan" : "text-yellow-500";
...
function StatCard({ icon, label, value, unit, subValue }: any) {
  return (
    <div className="border border-gray-900 p-6 rounded-3xl bg-[#0A0A0A] flex flex-col gap-2 relative overflow-hidden group">
      ...
      <div className="text-[10px] text-brand-cyan font-mono">{subValue}</div>
    </div>
  );
}
