...
import com.nexusguard.backend.repository.NodesRepository;
import com.nexusguard.backend.util.ConfusionMatrix;
                    ...
                    return reactor.core.publisher.Flux.fromIterable(txList)
                            ...
                            .flatMap(processedTxs -> {
                                ...
                                for (Transaction tx : processedTxs) {
                                    ...
                                    // NEXUS GUARD "WINNING" ENSEMBLE (Targeting FPR < 1.0% for UPI Blocking)
