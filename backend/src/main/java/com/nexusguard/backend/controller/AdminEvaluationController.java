...
import com.nexusguard.backend.service.ModelEvaluationService;
import com.nexusguard.backend.service.StatsService;
import com.nexusguard.backend.service.MetricsPdfService;
    ...
    public Mono<ResponseEntity<byte[]>> downloadMetricsPdf() {
        return evaluationService.evaluateModels(false).flatMap(metrics -> {
            try {
                ...
                String fn = "nexus-guard-metrics-" + ts + ".pdf";
